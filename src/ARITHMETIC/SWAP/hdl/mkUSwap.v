...
//
// On Mon Nov 23 15:21:39 PST 2020
//
//
// Ports:
// Name                         I/O  size props
...
// Date: 11/23/2020
// Description: A unconditional swap module. Always swaps the "i_A" and "i_B" input. Registered
// Ports:
// i_CLK: A 1-bit clock port
// i_A: A n-bit wide registered input
// i_B: A n-bit wide registered input
// o_A: A n-bit wide registered output. The "i_B" input is driven here.
// o_B: A n-bit wide registered output. The "i_A" input is driven here.
//
//
...
module mkUSwap(i_CLK,
  ...
  // register entity1_w_A
  assign entity1_w_A$D_IN = i_B ;
  assign entity1_w_A$EN = 1'd1 ;

  // register entity1_w_B
  assign entity1_w_B$D_IN = i_A ;
